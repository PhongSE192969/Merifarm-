...
export default function PolicyHero({ title, description }) {
  return (
    <section className="border-b border-soft bg-white py-12 md:py-16">
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="mt-5 inline-flex items-center gap-1.5 rounded-full bg-white px-3 py-1.5 text-xs text-faint ring-1 ring-soft">
          <Calendar size={12} />
