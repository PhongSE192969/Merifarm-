...
export default function NeedHelpCTA() {
  return (
    <section className="border-t border-soft bg-soft-green py-12">
      <div className="mx-auto max-w-6xl px-4">
        <div className="overflow-hidden rounded-card border border-soft bg-white shadow-md">
          <div className="border-b border-soft bg-primary-dark px-6 py-6 md:px-10">
            <h2 className="text-xl font-bold text-white md:text-2xl">Bạn cần hỗ trợ thêm?</h2>
          ...
          <div className="p-6 md:p-10">
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              <div className="flex items-center gap-3 rounded-xl bg-soft-green px-4 py-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-ink">0982 969 781</p>
                </div>
              </div>
              <div className="flex items-center gap-3 rounded-xl bg-soft-green px-4 py-3">
                <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-white text-primary shadow-sm">
              ...
              <div className="flex items-center gap-3 rounded-xl bg-soft-green px-4 py-3 sm:col-span-2 lg:col-span-1">
                <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-white text-primary shadow-sm">
                  <MapPin size={15} />
                </span>
                <div>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <Link
                to="/lien-he"
                className="inline-flex items-center gap-2 rounded-full bg-primary px-6 py-2.5 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-primary-dark"
              >
