    ...
    <div className="bg-white border-t border-soft py-8">
      <div className="mx-auto max-w-6xl px-4">
        <p className="max-w-4xl text-xs leading-relaxed text-faint">
          ...
          giao hàng, đổi trả và bảo mật thông tin cá nhân. Trong trường hợp có quy định pháp luật
          bắt buộc khác với nội dung chính sách này, quy định pháp luật hiện hành sẽ được ưu tiên
          áp dụng.
        </p>
      </div>
    </div>
